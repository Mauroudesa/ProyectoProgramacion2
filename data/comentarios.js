...
let comments = {
    lista: [
        { post_id: 1, user: users.findByUsername('Kunststort'), contenido: 'Muy buenooo', fecha: '15 de febrero', likes: 0, imgPerfil: "/images/perfil9.jpg" },
        { post_id: 1, user: users.findByUsername('Soma'), contenido: 'jajajajaja', fecha: '15 de febrero', likes: 2, imgPerfil: "/images/perfil7.jpg", },
        { post_id: 1, user: users.findByUsername('Kunststort'), contenido: 'Lo quierooo', fecha: '15 de febrero', likes: 2, imgPerfil: "/images/perfil9.jpg" },
